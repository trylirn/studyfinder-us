...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "U.S. Clinical Trials Directory | TrialFinderUS" },
      { name: "twitter:description", content: "Find recruiting clinical trials across the United States." },
    ],
        ...
        <div className="container mx-auto px-4 pt-16 pb-20 md:pt-24 md:pb-28">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <div className="mt-4">
              <Link
                to="/get-matched"
                className="inline-flex items-center gap-2 rounded-full bg-primary px-5 py-2 text-sm font-medium text-primary-foreground shadow-sm hover:bg-primary/90"
              >
                ✨ Take the free quiz — find trials near you
              </Link>
            </div>
            {trending.length > 0 && (
