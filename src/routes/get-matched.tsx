...
export const Route = createFileRoute("/get-matched")({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "Find a Clinical Trial Near You — Get Matched | TrialFinderUS" },
      { name: "twitter:description", content: "Free, private matching — no account required." },
    ],
